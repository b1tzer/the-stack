// 此文件由 scripts/generate-sidebar.mjs 自动生成，请勿手动编辑
  ...
  '/postgresql/': [
    {
      text: 'PG 到底特殊在哪',
      items: [
        { text: '为什么选 PG', link: '/postgresql/01-pg-unique/01-why-pg' },
        { text: 'MVCC 机制', link: '/postgresql/01-pg-unique/02-mvcc' },
        { text: 'VACUUM 机制', link: '/postgresql/01-pg-unique/03-vacuum' },
        { text: '类型系统', link: '/postgresql/01-pg-unique/04-type-system' },
      ],
    },
    {
      text: 'PG 的 SQL 能力强在哪',
      items: [
        { text: '窗口函数', link: '/postgresql/02-sql-power/01-window-function' },
        { text: 'CTE 与递归', link: '/postgresql/02-sql-power/02-cte-recursive' },
        { text: 'JSONB', link: '/postgresql/02-sql-power/03-jsonb' },
        { text: '全文搜索', link: '/postgresql/02-sql-power/04-full-text-search' },
        { text: 'PG 独有的 DML', link: '/postgresql/02-sql-power/05-returning-dml' },
      ],
    },
    {
      text: '索引是 PG 的第二把利器',
      items: [
        { text: '索引类型', link: '/postgresql/03-indexing/01-index-types' },
        { text: '索引设计', link: '/postgresql/03-indexing/02-index-design' },
        { text: 'EXPLAIN 深入', link: '/postgresql/03-indexing/03-explain' },
        { text: '表分区', link: '/postgresql/03-indexing/04-partitioning' },
      ],
    },
    {
      text: '并发控制',
      items: [
        { text: '隔离级别', link: '/postgresql/04-transactions/01-isolation-levels' },
        { text: '锁机制', link: '/postgresql/04-transactions/02-locking' },
        { text: '咨询锁', link: '/postgresql/04-transactions/03-advisory-lock' },
        { text: '并发实战', link: '/postgresql/04-transactions/04-concurrency-patterns' },
      ],
    },
    {
      text: '存储过程与触发器',
      items: [
        { text: 'PL/pgSQL 基础', link: '/postgresql/05-plpgsql/01-plpgsql-basics' },
        { text: '触发器', link: '/postgresql/05-plpgsql/02-triggers' },
        { text: '什么时候用存储过程', link: '/postgresql/05-plpgsql/03-when-to-use' },
      ],
    },
    {
      text: '性能优化',
      items: [
        { text: '配置调优', link: '/postgresql/06-performance/01-config-tuning' },
        { text: '查询优化', link: '/postgresql/06-performance/02-query-optimization' },
        { text: '性能监控', link: '/postgresql/06-performance/03-monitoring' },
        { text: '扩展策略', link: '/postgresql/06-performance/04-scaling' },
      ],
    },
    {
      text: '高可用与复制',
      items: [
        { text: '流复制', link: '/postgresql/07-ha/01-streaming-replication' },
        { text: '逻辑复制', link: '/postgresql/07-ha/02-logical-replication' },
        { text: '高可用方案', link: '/postgresql/07-ha/03-ha-solutions' },
        { text: '备份恢复', link: '/postgresql/07-ha/04-backup-restore' },
      ],
    },
    {
      text: '扩展与生态',
      items: [
        { text: '扩展机制', link: '/postgresql/08-ecosystem/01-extension-system' },
        { text: 'FDW 外部数据', link: '/postgresql/08-ecosystem/02-fdw' },
        { text: '垂直领域扩展', link: '/postgresql/08-ecosystem/03-specialized' },
      ],
    },
    {
      text: '日常运维',
      items: [
        { text: '用户与安全', link: '/postgresql/09-ops/01-user-security' },
        { text: '日常维护', link: '/postgresql/09-ops/02-maintenance' },
        { text: '数据迁移', link: '/postgresql/09-ops/03-migration' },
      ],
    },
    {
      text: '参考手册',
