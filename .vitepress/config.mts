      ...
      '/ai/': [
        {
          ...
          collapsed: true,
          items: [
            { text: '导论：什么是 AI Agent，这条路怎么走', link: '/ai/01-导论' },
            { text: 'LLM 接口与提示词工程', link: '/ai/02-LLM接口与提示词工程' },
            { text: 'RAG 架构与工程落地', link: '/ai/03-RAG架构与工程落地' },
            { text: 'Function Calling 与 Agent 范式', link: '/ai/04-FunctionCalling与Agent范式' },
            { text: '框架化开发：Python 三件套', link: '/ai/05-框架化开发-Python三件套' },
            { text: 'MCP 协议与工具生态', link: '/ai/06-MCP协议与工具生态' },
            { text: 'Agent 编排与状态持久化', link: '/ai/07-Agent编排与状态持久化' },
            { text: 'Memory 长期记忆', link: '/ai/08-Memory长期记忆' },
            { text: '评估与可观测性', link: '/ai/09-评估与可观测性' },
            { text: '安全护栏', link: '/ai/10-安全护栏' },
            { text: '端到端实战：从 0 到 1 搭一个生产 Agent', link: '/ai/11-端到端实战' },
          ],
        },
      ],
      '/design-pattern/': [
      ...
      '/kafka/': [
        {
          ...
          collapsed: true,
          items: [
            { text: 'Kafka 是什么', link: '/kafka/01-intro/chapter-01-what-is-kafka' },
            { text: '学习路径', link: '/kafka/01-intro/chapter-02-learning-path' },
            { text: '消息队列选型', link: '/kafka/01-intro/chapter-03-mq-comparison' },
          ],
        },
        {
          text: '核心概念',
          collapsed: true,
          items: [
            { text: '分区与 Offset', link: '/kafka/02-core/chapter-01-partition-and-offset' },
            { text: '生产者内部机制', link: '/kafka/02-core/chapter-02-producer-internals' },
            { text: '消费者组', link: '/kafka/02-core/chapter-03-consumer-group' },
            { text: '副本与 ISR', link: '/kafka/02-core/chapter-04-replication-and-isr' },
            { text: 'ACK 与幂等', link: '/kafka/02-core/chapter-05-ack-and-idempotence' },
            { text: 'Schema 与序列化', link: '/kafka/02-core/chapter-06-schema-and-serialization' },
            { text: '数据保留', link: '/kafka/02-core/chapter-07-data-retention' },
            { text: 'Controller 与 KRaft', link: '/kafka/02-core/chapter-08-controller-and-kraft' },
          ],
        },
        {
          text: '可靠性',
          collapsed: true,
          items: [
            { text: '消息丢失排查', link: '/kafka/03-reliability/chapter-01-message-loss' },
            { text: '消息去重', link: '/kafka/03-reliability/chapter-02-message-dedup' },
            { text: '消息顺序', link: '/kafka/03-reliability/chapter-03-message-ordering' },
            { text: 'Exactly Once', link: '/kafka/03-reliability/chapter-04-exactly-once' },
          ],
        },
        {
          text: '性能',
          collapsed: true,
          items: [
            { text: '为什么 Kafka 这么快', link: '/kafka/04-performance/chapter-01-why-kafka-is-fast' },
            { text: '吞吐调优', link: '/kafka/04-performance/chapter-02-throughput-tuning' },
            { text: '分区数选择', link: '/kafka/04-performance/chapter-03-partition-sizing' },
            { text: '压缩权衡', link: '/kafka/04-performance/chapter-04-compression-tradeoff' },
          ],
        },
        {
          text: '排查',
          collapsed: true,
          items: [
            { text: '消费者 Lag 过大', link: '/kafka/05-troubleshooting/chapter-01-consumer-lag' },
            { text: 'ISR 频繁收缩', link: '/kafka/05-troubleshooting/chapter-02-isr-shrink' },
            { text: '消息丢失排查', link: '/kafka/05-troubleshooting/chapter-03-message-loss-debug' },
            { text: '高延迟排查', link: '/kafka/05-troubleshooting/chapter-04-high-latency' },
            { text: '磁盘空间不足', link: '/kafka/05-troubleshooting/chapter-05-disk-space' },
            { text: 'Broker 故障', link: '/kafka/05-troubleshooting/chapter-06-broker-failure' },
          ],
        },
        {
          text: '参考',
          collapsed: true,
          items: [
            { text: 'RecordBatch 格式', link: '/kafka/reference/chapter-01-record-batch-format' },
            { text: '日志分段与索引', link: '/kafka/reference/chapter-02-log-segment' },
      ...
      '/mysql/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '在线 DDL', link: '/mysql/08-operations/chapter-07-online-ddl' },
            { text: '数据迁移', link: '/mysql/08-operations/chapter-08-data-migration' },
          ],
        },
        {
          text: '实战',
