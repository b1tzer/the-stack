  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          { text: 'Kafka', link: '/kafka/_intro/chapter-01-what-is-kafka' },
      ...
      '/kafka/': [
        {
          ...
          collapsed: true,
          items: [
            { text: 'Kafka 是什么', link: '/kafka/_intro/chapter-01-what-is-kafka' },
            { text: '学习路径', link: '/kafka/_intro/chapter-02-learning-path' },
            { text: '消息队列选型', link: '/kafka/_intro/chapter-03-mq-comparison' },
          ],
        },
        {
          text: '核心概念',
          collapsed: true,
          items: [
            { text: '分区与 Offset', link: '/kafka/_core/chapter-01-partition-and-offset' },
            { text: '生产者内部机制', link: '/kafka/_core/chapter-02-producer-internals' },
            { text: '消费者组', link: '/kafka/_core/chapter-03-consumer-group' },
            { text: '副本与 ISR', link: '/kafka/_core/chapter-04-replication-and-isr' },
            { text: 'ACK 与幂等', link: '/kafka/_core/chapter-05-ack-and-idempotence' },
            { text: 'Schema 与序列化', link: '/kafka/_core/chapter-06-schema-and-serialization' },
            { text: '数据保留', link: '/kafka/_core/chapter-07-data-retention' },
            { text: 'Controller 与 KRaft', link: '/kafka/_core/chapter-08-controller-and-kraft' },
          ],
        },
        {
          text: '可靠性',
          collapsed: true,
          items: [
            { text: '消息丢失排查', link: '/kafka/reliability/chapter-01-message-loss' },
            { text: '消息去重', link: '/kafka/reliability/chapter-02-message-dedup' },
            { text: '消息顺序', link: '/kafka/reliability/chapter-03-message-ordering' },
            { text: 'Exactly Once', link: '/kafka/reliability/chapter-04-exactly-once' },
          ],
        },
        {
          text: '性能',
          collapsed: true,
          items: [
            { text: '为什么 Kafka 这么快', link: '/kafka/performance/chapter-01-why-kafka-is-fast' },
            { text: '吞吐调优', link: '/kafka/performance/chapter-02-throughput-tuning' },
            { text: '分区数选择', link: '/kafka/performance/chapter-03-partition-sizing' },
            { text: '压缩权衡', link: '/kafka/performance/chapter-04-compression-tradeoff' },
          ],
        },
        {
          text: '排查',
          collapsed: true,
          items: [
            { text: '消费者 Lag 过大', link: '/kafka/troubleshooting/chapter-01-consumer-lag' },
            { text: 'ISR 频繁收缩', link: '/kafka/troubleshooting/chapter-02-isr-shrink' },
            { text: '消息丢失排查', link: '/kafka/troubleshooting/chapter-03-message-loss-debug' },
            { text: '高延迟排查', link: '/kafka/troubleshooting/chapter-04-high-latency' },
            { text: '磁盘空间不足', link: '/kafka/troubleshooting/chapter-05-disk-space' },
            { text: 'Broker 故障', link: '/kafka/troubleshooting/chapter-06-broker-failure' },
          ],
        },
        {
          text: '流处理',
        ...
        },
        {
          ...
          items: [
            ...
            { text: '多集群', link: '/kafka/10-multi-cluster/chapter-01-scenarios' },
          ],
        },
        {
          text: '实战',
