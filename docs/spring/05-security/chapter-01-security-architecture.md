...
这三项数据安全能力不依赖 Spring Security，属于通用 Java 技术，落地代码统一见 [安全实践](../../engineering/07-security/chapter-05-security-practice.md)：

- **敏感数据加密存储**（AES-GCM）：见 [安全实践](../../engineering/07-security/chapter-05-security-practice.md) §6
- **日志脱敏**（Logback Converter）：见 [安全实践](../../engineering/07-security/chapter-05-security-practice.md) §7
- **操作审计**（AOP 切面）：见 [安全实践](../../engineering/07-security/chapter-05-security-practice.md) §8
