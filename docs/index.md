...
hero:
  name: "The Stack"
  text: "系统化的 Java 后端技术分析"
  tagline: "从语言基石到分布式架构，沉淀 10 大专题、380+ 篇深度文章。"
  actions:
    - theme: brand
      text: 开始阅读
...
features:
  ...
  - icon: 🍃
    ...
    link: /spring/01-core/chapter-01-spring-overview
  - icon: 🗄️
    title: Redis
  ...
  - icon: 🔍
    ...
    link: /elasticsearch/01-basics/chapter-01-overview
  - icon: 🧩
    title: 设计模式
    details: 创建型、结构型、行为型经典设计模式逐一拆解。
    link: /design-pattern/00-intro/chapter-01-why-patterns
  - icon: 🏗️
    title: 软件工程
    details: SOLID、架构演进、DDD、系统设计与工程实践。
    link: /engineering/01-principles/chapter-01-overview
  - icon: 🤖
    title: AI 工程
