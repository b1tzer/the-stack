...
> **与 Spring 微服务文档的分工**：本文聚焦架构理论和选型决策，具体的 Spring Cloud 组件原理和落地实践请参考 [服务调用](../../spring/09-distributed/chapter-04-service-call.md) 和 [服务容错](../../spring/09-distributed/chapter-05-circuit-breaker.md)。
